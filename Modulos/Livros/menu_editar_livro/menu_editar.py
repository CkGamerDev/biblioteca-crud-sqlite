...
from Modulos.Livros.menu_editar_livro.editar_livro import funcao_menu_editando 
from Modulos.Livros.menu_editar_livro.excluir_livro import funcao_excluir_livro
